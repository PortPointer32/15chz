...
db = Database('/home/str/15chz/cfg/database')
        ...
        if message.text == "/buy1":
            ...
            await bot.send_message(
                text=MESSAGES["buy_1"] % (data["city"], data["district"], data["name_product"], data["price_product"],
                                          f"{count_pay*0.48:.8f}", num_pay, number_order, number_comment), chat_id=message.from_user.id)
