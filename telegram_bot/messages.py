...
# СООБЩЕНИЯ ОТ БОТА
start_message = """<b>Вас приветствует магазин</b> - chizzgshop.biz 

Наши контакты: 
Jabber:
Telegram:
Сайт автопродаж - https://chizzgshop.biz
...
captha_message = "Введите код с картинки 👆"
...
pay5_what_pay_message = "<b>Litecoin</b>"
...
👉<code>%s</code>
➖
❗️<b> Реквизиты действительны в течении 30 минут!</b>
➖
...
➖➖
<b>Оплата принимается только на НОМЕР БАНКОВСКОЙ КАРТЫ.</b> Пополнить банковскую карту можно любым удобным способом, например: со своего QIWI-кошелька, терминала, банковской карты (card2card), Yandex.Деньги, Payeer, WebMoney и другие платежные системы.
➖➖
...
start_3_message = """<b>Вас приветствует магазин - EL CHAPO
Работай в EL CHAPO на лучших условиях!
